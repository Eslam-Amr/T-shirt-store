        ...
        <div class="container">
            <div class="row">@dd($from)
                <div class="col-lg-3">
                  ...
                  d                  <span>Min: <span id="min-price-value">100</span></span>
                        ...
                        <aside class="left_widgets p_filter_widgets price_rangs_aside">
                            ...
                            {{-- <input type="number"  style="background-color: rgba(0, 0, 0, 0.15);width: 300px" class=" form-control" name="from" id="amount"  /> --}}
                              ...
                              <div class="input-container">
                                <span>From</span>
                                {{-- <input type="number" class="input-field form-control" wire:model="from" name="from" value="{{ isset($data['from']) ? $data['from'] : 0  }}"> --}}
                                <input type="number" class="input-field form-control" wire:model="from" name="from" >
                                <span>To</span>
                                {{-- <input type="number" class="input-field form-control" wire:model="to" name="to" value="{{ isset($data['to']) ? $data['to'] : 500  }}"> --}}
                                ...
                                {{-- <div class="range_item">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="price_value d-flex justify-content-center">
                                            <input type="text" wire:model="from" class="js-input-from"  name="from" id="amount"  />
                                            <span>to</span>
                                            <input type="text" wire:model="to" class="js-input-to" id="amount"  name="to"  />
                                        </div>
                                    </div>
                                </div> --}}
                ...
                <div class="col-lg-9">
                            ...
                            <div class="product_top_bar d-flex justify-content-between align-items-center">
                                ...
                                <div class="single_product_menu d-flex">
                                    <div class="input-group">
                                        <input type="text" id="search" id="searchInput" wire:model.debounce.350ms="search" class="form-control" placeholder="search"
                    ...
                    <div id="memListTable" class="row align-items-center latest_product_inner">
